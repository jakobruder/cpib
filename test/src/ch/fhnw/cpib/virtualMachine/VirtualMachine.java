...
package ch.fhnw.cpib.virtualMachine;

import ch.fhnw.cpib.virtualMachine.IInstructions.AddInt;
import ch.fhnw.cpib.virtualMachine.IInstructions.AllocBlock;
import ch.fhnw.cpib.virtualMachine.IInstructions.AllocStack;
import ch.fhnw.cpib.virtualMachine.IInstructions.Call;
import ch.fhnw.cpib.virtualMachine.IInstructions.CondJump;
import ch.fhnw.cpib.virtualMachine.IInstructions.Deref;
import ch.fhnw.cpib.virtualMachine.IInstructions.DivTruncInt;
import ch.fhnw.cpib.virtualMachine.IInstructions.Dup;
import ch.fhnw.cpib.virtualMachine.IInstructions.EqInt;
import ch.fhnw.cpib.virtualMachine.IInstructions.GeInt;
import ch.fhnw.cpib.virtualMachine.IInstructions.GtInt;
import ch.fhnw.cpib.virtualMachine.IInstructions.IExecInstr;
import ch.fhnw.cpib.virtualMachine.IInstructions.InputBool;
import ch.fhnw.cpib.virtualMachine.IInstructions.InputInt;
import ch.fhnw.cpib.virtualMachine.IInstructions.LeInt;
import ch.fhnw.cpib.virtualMachine.IInstructions.LoadAddrRel;
import ch.fhnw.cpib.virtualMachine.IInstructions.LoadImInt;
import ch.fhnw.cpib.virtualMachine.IInstructions.LtInt;
import ch.fhnw.cpib.virtualMachine.IInstructions.ModTruncInt;
import ch.fhnw.cpib.virtualMachine.IInstructions.MultInt;
import ch.fhnw.cpib.virtualMachine.IInstructions.NeInt;
import ch.fhnw.cpib.virtualMachine.IInstructions.NegInt;
import ch.fhnw.cpib.virtualMachine.IInstructions.OutputBool;
import ch.fhnw.cpib.virtualMachine.IInstructions.OutputInt;
import ch.fhnw.cpib.virtualMachine.IInstructions.Return;
import ch.fhnw.cpib.virtualMachine.IInstructions.Stop;
import ch.fhnw.cpib.virtualMachine.IInstructions.Store;
import ch.fhnw.cpib.virtualMachine.IInstructions.SubInt;
